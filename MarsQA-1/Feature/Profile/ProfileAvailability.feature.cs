...
namespace MarsQA_1.Feature.Profile
{
    ...
    [NUnit.Framework.DescriptionAttribute("Seller Add Avaiability to Profile")]
    public partial class SellerAddAvaiabilityToProfileFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Seller Add Avaiability to Profile", "As a Seller\r\nI want the feature to add availability to my Profile Details\r\nSo tha" +
                    "t\r\nThe people seeking for some availablity can look into my details.", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Delete Availablity from profile")]
        [NUnit.Framework.CategoryAttribute("mytag")]
        public virtual void DeleteAvailablityFromProfile()
        {
            string[] tagsOfScenario = new string[] {
                    "mytag"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Delete Availablity from profile", null, new string[] {
                        "mytag"});
#line 16
this.ScenarioInitialize(scenarioInfo);
#line hidden
...
#line hidden
#line 19
 testRunner.Then("availability delete successful", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
